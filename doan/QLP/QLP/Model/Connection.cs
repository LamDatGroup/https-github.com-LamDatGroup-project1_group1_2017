...
namespace QLP.Model
{
    class Connection
    {
        ...
        public static string sqlcon = @"Data Source=.;Initial Catalog = QLPhim; Integrated Security = true; User ID = sa; Password = gintama0 ";
        ...
        public static bool ExcuteScalar(string strQuery, CommandType cmdtype,params SqlParameter[] paramater)
        {
